...
class _WithdrawalViewState extends ConsumerState<WithdrawalView> with SingleTickerProviderStateMixin {
  String _amountText = "1000"; // Default starting withdrawal
  ...
  Future<void> _executeWithdrawal() async {
    ...
    if (amount > portfolio.availableCash) {
      HapticFeedback.vibrate();
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Insufficient balance. You only have \$${portfolio.availableCash.toStringAsFixed(2)} available.')),
      );
      setState(() {
        _isSubmitting = false;
        _swipeProgress = 0.0;
    ...
    final result = await ref.read(portfolioProvider.notifier).withdrawCash(amount, _selectedBank);
  ...
  Widget build(BuildContext context) {
    ...
    Widget body = ConfettiOverlay(
      ...
      child: _isSuccess ? _buildSuccessView() : _buildWithdrawalForm(isDark),
    );
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    "Available Cash: \$${portfolio.availableCash.toStringAsFixed(2)}",
                    style: TextStyle(
              ...
              Positioned(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    height: buttonSize,
                    decoration: const BoxDecoration(
                      color: Color(0xFFEF4444), // Crimson red handle
                      shape: BoxShape.circle,
                    ),
                    alignment: Alignment.center,
                    child: _isSubmitting
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              height: 100,
              decoration: const BoxDecoration(
                color: Color(0xFFEF4444), // Crimson red success check
                shape: BoxShape.circle,
              ),
            ...
            const SizedBox(height: 12),
            Text(
              "Successfully requested withdrawal of \$${_formatAmount(_amountText)} to your account $_selectedBank. Funds will arrive shortly.",
